            ...
            children: [
              Flexible(
                child: ListTile(
                  ...
                  title: Text(style: TextStyle(color: Color(0xffEB9F4A)), "3"),
                ),
              ),
              Flexible(
                child: ListTile(
                  leading: Icon(color: Color(0xff338F9B), FontAwesomeIcons.box),
                  title:
                      Text(style: TextStyle(color: Color(0xff338F9B)), "234XP"),
                ),
              ),
              Flexible(
                child: ListTile(
                  leading:
                      Icon(color: Color(0xffDC3F00), FontAwesomeIcons.heart),
                  title:
                      Icon(color: Color(0xffDC3F00), FontAwesomeIcons.infinity),
                ),
              ),
            ],
          ),
