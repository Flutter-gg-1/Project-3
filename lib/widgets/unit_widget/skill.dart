...
import 'package:multi_border/multi_border.dart';  // library to implement double border

// widget represents skill
          ...
          children: [
            ...
            Padding(
              ...
              child: Stack(
                ...
                children:[
                  Image.asset('assets/images/crown.png', height: 27,width: 31),
                  Text(level?.toString() ?? "", style: const TextStyle(fontSize: 15))
                ]
              ),
            )
          ]
