          ...
          children: [
            Container(
              ...
              child: Row(
                ...
                children: [
                  const Text("Verbal skills",style: TextStyle(fontSize: 30, color: Color.fromRGBO(0, 0, 0, 0.9))),
                  Row(
                    children: [
                      Image.asset("assets/images/crown.png"),
                      const SizedBox(width: 10),
                      const Text("3",style:TextStyle(fontSize: 25, color: Color(0xffECC055)))
                    ],
                  ),
                  Row(
                    children: [
                      ...
                      const SizedBox(width: 10),
                      const Text("213",style: TextStyle(fontSize: 25, color: Color(0xff02A1FB)))
                    ],
                  ),
                ],
              ),
            ...
            Flexible(
              ...
              children: [
                ...
                const Row(
                  ...
                  children: [
                    Skill(assetImage: "assets/images/pencil.png", skillName:"Intro",level: 1,),
                  ],
                ),
                const Row(
                  mainAxisAlignment: MainAxisAlignment.center,
