                          ...
                          child: Container(
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Container(
                                    margin: EdgeInsets.fromLTRB(1, 0, 0, 130),
                                    child: Text(
                                      'Unit 1',
                                      style: GoogleFonts.getFont(
                                        'Roboto',
                          ...
                          child: Container(
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Container(
                                    margin: EdgeInsets.fromLTRB(1, 0, 0, 132),
                                    child: Text(
                                      'Unit 1',
                                      style: GoogleFonts.getFont(
                                        'Roboto',
...
// تم تصميم واجهة المستخدم هذه لعرض تقدم المستخدم في مجالات مختلفة. 
// يتكون التصميم من عدة أقسام:
// 
// 1. **القسم العلوي**:
//    - يحتوي على خلفية ملونة بشكل خفيف.
//    - يعرض عدد النقاط المكتسبة وتجربة المستخدم (XP) مع أيقونات متعلقة.
// 
// 2. **المنطق الاستدلالي**:
//    - يعرض تقدم المستخدم في مجال "المنطق الاستدلالي" مع نسبة التقدم في شكل شريط تقدم.
//    - يحتوي على زر يمكن الضغط عليه للانتقال إلى صفحة "VerbalSkills".
// 
// 3. **التفكير الفني**:
//    - يعرض تقدم المستخدم في مجال "التفكير الفني" مع نسبة التقدم في شكل شريط تقدم.
//    - يحتوي على زر يمكن الضغط عليه للانتقال إلى صفحة "VerbalSkills".
// 
// 4. **المهارات اللفظية**:
//    - يعرض تقدم المستخدم في مجال "المهارات اللفظية" مع نسبة التقدم في شكل شريط تقدم.
//    - يحتوي على زر يمكن الضغط عليه للانتقال إلى صفحة "VerbalSkills".
// 
// 5. **التصميم العام**:
//    - استخدام ألوان وتصميمات مختلفة لتعزيز تجربة المستخدم.
//    - استخدام رموز SVG لتصميم أيقونات وواجهة مرئية جذابة.
// 
// تم تضمين مكونات مختلفة مثل `LinearProgressIndicator` و`InkWell` لتوفير تفاعل جيد مع المستخدم وتقديم معلومات شاملة.
