...
//  HomeScreen كوريثة لـ StatefulWidget  ل إدارة  الصفحة بشكل ديناميكي 
//  _pages تحتوي على الصفحات الأربع التي سيتم عرضها عند التبديل بين علامات التبويب
//    _navBarItems تحتوي على عناصر شريط التنقل السفلي مع إعدادات الأيقونات والألوان
