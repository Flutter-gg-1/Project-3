...
// تم عمل في هذه الواجهة لتصميم صفحة "Verbal Skills" التي تعرض مهارات لفظية مختلفة.
// تحتوي الصفحة على مجموعة من الأيقونات الدائرية المخصصة على شكل "CircularIconWithLabel" التي تعرض مجموعة من العناصر المرتبطة بالمهارات اللفظية.
// الأيقونات تتضمن رموزًا مصورة وSVG، مع وجود تسميات توضيحية للأيقونات مع أرقام.
// يتم ترتيب الأيقونات بشكل تراكبي لتوفير تجربة بصرية منظمة.
// في الجزء العلوي من الصفحة، هناك شريط يحتوي على عنوان "Verbal skills" مع تفاصيل عددية متعلقة بالوحدات.
// هناك أيضًا شريط تقدم داخل حاوية، يعرض تقدم وحدة معينة.
// الخلفية تحتوي على صورة إضافية في الأعلى لتجميل التصميم.
// التصميم يستخدم حاويات متعددة وألوان خلفية لتقديم تجربة بصرية جذابة ومرتبة.
