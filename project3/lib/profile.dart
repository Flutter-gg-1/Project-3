...
//  استخدامت `ListView` لعرض قائمة المشاريع مع إمكانية التمرير العمودي لرؤية جميع العناصر
//  استخدامت `Image` لعرض الصور المرفقة  
//  استخدامت `Column` و `Row` لترتيب العناصر بشكل منسق 
// استخدامت`Icon` لتمثيل  أيقونات واضحة 
// استخدامت`Navigator` لانتقال  بين الصفحات
//استخدامت  `Padding` و `Margin` لتحسين  العناصر وتباعدها
//استخدامت `Expanded`  لمرونه للعناصر ضمن واجهة المستخدم
